function data = pulldata

%%% pulldata.m - Extract tariff information from a collection of UK Power tariff reports
%%% held in a specified folder. Information is collated and combined with
%%% discount information contained in Discount Data.xlsx. Data is
%%% translated into an output data struct.
